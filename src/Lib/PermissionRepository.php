...
class PermissionRepository
{
    ...
    protected $current_role_ids = null;
    protected $active_role_id = null;
     ...
     */
    public function rolePermissions(int $role_id)
    {
     ...
     */
    public function canAccess(array $role_ids = null)
    {
        if (!$role_ids && !$this->current_role_ids) {
            return true;
        }
        $role_ids = $role_ids ? $role_ids : $this->current_role_ids;
        $can = false;
        $active_role_id = null;
        foreach ($role_ids as $role_id) {
            if ($this->roleCurrentPermission($role_id)) {
                $can = true;
        ...
        return $can ? $active_role_id : false;
    }
    ...
    public function setCurrentRoleIds(array $role_ids)
    {
        $this->current_role_ids = $role_ids;
    }
    ...
    public function setActiveRoleId(int $role_id)
    {
        $this->active_role_id = $role_id;
    }
